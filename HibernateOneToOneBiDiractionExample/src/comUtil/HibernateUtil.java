...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory() {
		if (sf == null) {
			...
			map.put(Environment.URL, "jdbc:mysql://localhost:3306/HibernateByDiractionExample");
			...
			MetadataSources mds = new MetadataSources(regestry).addAnnotatedClass(Person.class)
