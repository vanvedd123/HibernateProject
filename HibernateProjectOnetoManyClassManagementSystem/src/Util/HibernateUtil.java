...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory() {
		...
		map.put(Environment.URL, "jdbc:mysql://localhost:3306/HibernateOneToMenyExampleProjectClasMngagement");
		...
		MetadataSources mds = new MetadataSources(regestry).addAnnotatedClass(Course.class)
				.addAnnotatedClass(Faculty.class).addAnnotatedClass(Batch.class).addAnnotatedClass(Student.class);
